...
export function createApp({ articles, highlights, users, feedSources, rawArticles }: AppDeps) {
  const app = express();
  ...
  app.use("/api/articles/:id/highlights", highlightsRouter(articles, highlights));
