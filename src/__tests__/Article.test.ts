...
describe("Article", () => {
  /**
   * An Article represents a scraped news article with all original metadata intact.
   * This is the internal representation — users never see this directly.
   * The sourceId and url fields tie the article back to its origin,
   * which is revealed only in aggregate propaganda statistics.
   */
